...
import 'dashboardNavigationBar.dart';

class StudentTransferDetailsPage extends StatefulWidget {
  const StudentTransferDetailsPage({super.key, required this.name});
  final String name;

  @override
  State<StudentTransferDetailsPage> createState() =>
      _TransferDetailsPageState();
}

class _TransferDetailsPageState extends State<StudentTransferDetailsPage> {
        ...
        builder: (x) => Center(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () {
                        context.pushOff(const DashboardNavigationBar());
                      },
